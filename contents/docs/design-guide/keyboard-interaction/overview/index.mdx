...
- **<a href="/docs/design-guide/keyboard-interaction/question-1">Question 1:</a>** Are adjacent links, such as images and text links, that point to the same location combined into a single CTA?
- **<a href="/docs/design-guide/keyboard-interaction/question-2">Question 2:</a>** Are all calls to action (CTAs) built to fully function with keyboard and touch in addition to the mouse?
- **<a href="/docs/design-guide/keyboard-interaction/question-3">Question 3:</a>** Are we avoiding keyboard traps?
- **<a href="/docs/design-guide/keyboard-interaction/question-4">Question 4:</a>** Can single-character shortcuts be turned off or remapped, or are they only triggered when the relevant control has focus??
- **<a href="/docs/design-guide/keyboard-interaction/question-5">Question 5:</a>** Can users cancel an operation by moving focus away from a control before releasing it?
- **<a href="/docs/design-guide/keyboard-interaction/question-6">Question 6:</a>** Is tabbing order predictable, logical, and intuitive?
- **<a href="/docs/design-guide/keyboard-interaction/question-7">Question 7:</a>** Are buttons, links, and other CTAs designed to consider both hover and focus states?
- **<a href="/docs/design-guide/keyboard-interaction/question-8">Question 8:</a>** Is the focus indicator clearly visible when active elements receive focus?
- **<a href="/docs/design-guide/keyboard-interaction/question-9">Question 9:</a>** Is there a skip-to-main-content link provided?
- **<a href="/docs/design-guide/keyboard-interaction/question-10">Question 10:</a>** Are users able to dismiss newly displayed content without moving their mouse or shifting focus?
